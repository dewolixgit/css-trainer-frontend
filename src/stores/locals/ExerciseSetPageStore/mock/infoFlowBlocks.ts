...
import { InfoFlowCodeBlockApi } from 'entities/contentFlowBlock/infoFlowBlock/infoFlowCodeBlock';
...
export const INFO_FLOW_BLOCKS_MOCK: (
...
)[] = [
  {
    ...
    text: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor <code>incididunt ut</code> labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.',
  },
  {
    id: 2,
    contentType: ContentFlowBlockType.info,

...
import backgroundImage from 'models/exersices/SetPseudoClassElement/Layout/img/background.jpg';
import plainScrollImage from 'models/exersices/SetPseudoClassElement/Layout/img/plain-scroll.svg';

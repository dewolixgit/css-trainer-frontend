...
const Practice: React.FC = () => {
  return (
    <div>
      Практика Практика Практика Практика Практика Практика Практика Практика Lorem ipsum dolor sit
      amet, consectetur adipisicing elit. A, amet animi corporis cumque dolorem dolores ea eius,
